...
public class LoadMC {
    ...
    public static void main(String[] args) {
        ...
        S.getDTFromFile("D:\\Research\\data\\MemphisDataSet\\resourses\\memphis_dt.txt");
    ...
    double[][][][] getMCFromFile(String fileName) {
        double[][][][] M=null;
        try {
...
//        String s = sc.nextLine();
    ...
    int[][] getDTFromFile(String fileName) {
        int[][] D = null;
        try {
            File input = new File(fileName);
            Scanner sc = new Scanner(input);
...
//                String s = sc.nextLine();
    ...
    int[][][] getRFromFile(String fileName) {
        int[][][] R = null;
        try {
            File input = new File(fileName);
            Scanner sc = new Scanner(input);
